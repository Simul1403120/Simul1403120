...
I am an **Assistant Professor in Electrical and Electronic Engineering at Dhaka University of Engineering & Technology (DUET), Bangladesh**, with research interests spanning **Machine Learning, Deep Learning, Computer Vision, Image Processing, Signal Processing, Explainable AI, NLP, and LLMs**.
...
* **Blood cell classification and microscopic blood-smear analysis**
* **Rouleaux identification in red blood cells**
* **Brain tumor classification**
* **Skin cancer and skin disease classification**
* **Epileptic seizure prediction**
* **Diabetes and heart disease prediction**
* **Plant disease and pest identification**
* **Nutrient deficiency diagnosis**
* **Explainable AI for healthcare**
* **Transfer learning and lightweight deep-learning architectures**
...
* *Smart Agricultural Technology* — Q1
...
`CNN` · `Transfer Learning` · `Ensemble Learning` · `Image Segmentation` · `Computer Vision` · `XAI` · `Medical AI`

My primary technical stack includes Python, TensorFlow, Keras, Scikit-learn, NumPy, Pandas, and Matplotlib.
...
🇰🇷 **Republic of Korea** — Nuclear power plant licensing, construction preparation and oversight

🇷🇺 **Russia** — Nuclear security and VVER-1200/AES-2006 technology
...
**Artificial Intelligence × Computer Vision × Medical Imaging × Explainable AI**
